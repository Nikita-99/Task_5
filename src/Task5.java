...
public class Task5 {
    ...
    public static void main(String[] args) {
        System.out.println(Zad1.encrypt("Hello"));
        System.out.println(Zad1.decrypt( new int[]{ 72, 33, -73, 84, -12, -3, 13, -13, -68 }));
        System.out.println(Zad2.canMove("Rook", "A8", "H8"));
        System.out.println(Zad3.canComplete("bauul", "beautiful"));
        System.out.println(Zad4.sumDigProd(16, 28));
        System.out.println(Zad5.sameVowelGroup("toe", "ocelot", "maniac"));
        System.out.println(Zad6.validateCard(new BigInteger("1234567890123452")));
        System.out.println(Zad7.numToEng(909));
        System.out.println(Zad8.getSha256Hash("password123"));
        System.out.println(Zad9.correctTitle("jOn SnoW, kINg IN thE noRth."));
        Zad10.hexLattice(37);
...
class Zad2 {
    public static boolean canMove(String s, String start, String end) {
        String regex = "ABCDEFGH12345678";
        //if (!(start.matches(regex) & end.matches(regex))) return false;
